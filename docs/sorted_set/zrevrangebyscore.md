...
除了成员按 `score` 值递减的次序排列这一点外， [ZREVRANGEBYSCORE](#zrevrangebyscore) 命令的其他方面和 [ZRANGEBYSCORE key min max [WITHSCORES] [LIMIT offset count]](zrangebyscore.md#zrangebyscore) 命令一样。
